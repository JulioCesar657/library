...
-- -----------------------------------------------------
-- Schema 3850603_mylibrary
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema 3850603_mylibrary
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `3850603_mylibrary` DEFAULT CHARACTER SET utf8 ;
USE `3850603_mylibrary` ;

-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`TIPO_USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`TIPO_USUARIO` (
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`EIXO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`EIXO` (
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`CURSO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`CURSO` (
  ...
  CONSTRAINT `fk_CURSO_EIXO1`
    ...
    REFERENCES `3850603_mylibrary`.`EIXO` (`IDEIXO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`USUARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`USUARIO` (
  ...
  CONSTRAINT `fk_USUARIO_TIPO_USUARIO`
    ...
    REFERENCES `3850603_mylibrary`.`TIPO_USUARIO` (`IDTIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_USUARIO_CURSO1`
    FOREIGN KEY (`CURSO_IDCURSO`)
    REFERENCES `3850603_mylibrary`.`CURSO` (`IDCURSO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`HISTORICO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`HISTORICO` (
  ...
  CONSTRAINT `fk_HISTORICO_USUARIO1`
    ...
    REFERENCES `3850603_mylibrary`.`USUARIO` (`IDUSUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`TRABALHO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`TRABALHO` (
  ...
  CONSTRAINT `fk_TRABALHO_HISTORICO1`
    ...
    REFERENCES `3850603_mylibrary`.`HISTORICO` (`IDHISTORICO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `3850603_mylibrary`.`AUTOR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `3850603_mylibrary`.`AUTOR` (
  `USUARIO_IDUSUARIO` INT NOT NULL,
  ...
  CONSTRAINT `fk_USUARIO_has_TRABALHO_TRABALHO1`
    ...
    REFERENCES `3850603_mylibrary`.`TRABALHO` (`IDTRABALHO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
